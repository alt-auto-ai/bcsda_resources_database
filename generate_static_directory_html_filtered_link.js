    ...
    <script>
      (function () {
        ...
        function applyFiltersFromUrl() {
          ...
          const themes = getUrlFilterValues(params, "theme");
          const documentTypes = getUrlFilterValues(params, "type").concat(
            getUrlFilterValues(params, "documentType")
          );
          const years = getUrlFilterValues(params, "year");

          if (title) {
            state.filters.title = cleanText(title);
            elements.titleFilter.value = state.filters.title;
          }
          if (themes.length) {
            state.filters.theme = themes;
          }
          if (documentTypes.length) {
            state.filters.documentType = Array.from(new Set(documentTypes));
          }
          if (years.length) {
        ...
        function updateUrlFromFilters() {
          ...
          if (cleanText(state.filters.title)) {
            params.set("title", cleanText(state.filters.title));
          }
          state.filters.theme.forEach(function (value) {
            params.append("theme", value);
          });
          state.filters.documentType.forEach(function (value) {
            params.append("type", value);
          });
          state.filters.year.forEach(function (value) {
        ...
        function runFilterPipeline(shouldUpdateUrl) {
        ...
        function updateDropdown(key, filterSnapshot) {
          ...
          const baseOptions =
            key === "documentType"
              ? mergeOptionsWithSelected(availableOptions, ["AI Tool", "Tool"])
              : availableOptions;
          ...
          const displayOptions = mergeOptionsWithSelected(baseOptions, persistedValues);
          ...
          setOptionAvailability(config.element, new Set(baseOptions));
        }
